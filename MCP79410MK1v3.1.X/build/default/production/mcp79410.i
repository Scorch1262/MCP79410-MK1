...
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\include\\c99\\assert.h" 1 3
# 14 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\include\\c99\\assert.h" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\include\\c99\\bits/assert.h" 1 3
# 19 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\include\\c99\\bits/assert.h" 3
          void __assert_fail (const char *, const char *, int, const char *);
# 14 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\include\\c99\\assert.h" 2 3
...
# 36 "./mcp79410.h" 2
# 83 "./mcp79410.h"
void MCP79410_set_date_time(uint8_t day,
                            uint8_t mouth,
                            uint8_t year,
                            uint8_t hour,
                            uint8_t min);
void MCP79410_get_date (uint8_t *day,
                        uint8_t *mouth,
                        uint8_t *year);
void MCP79410_get_time (uint8_t *hour,
                        uint8_t *min,
                        uint8_t *sec);
# 14 "mcp79410.c" 2
# 37 "mcp79410.c"
...
void MCP79410_set_date_time(
    ...
    I2C_Write1ByteRegister(0x6F, 0x03, 0x08);
    I2C_Write1ByteRegister(0x6F, 0x00, 0x80);
    I2C_Write1ByteRegister(0x6F, 0x02, 0x01);
    I2C_Write1ByteRegister(0x6F, 0x07, 0x40);
    _delay((unsigned long)((1000)*(8000000/4000.0)));

    day = day & 0b00111111;
    I2C_Write1ByteRegister(0x6F, 0x04, day);

    mouth = mouth & 0b00111111;
    I2C_Write1ByteRegister(0x6F, 0x05, mouth);

    year = year & 0b11111111;
    I2C_Write1ByteRegister(0x6F, 0x06, year);

    hour = hour & 0b01111111;
    I2C_Write1ByteRegister(0x6F, 0x02, hour);

    min = min & 0b01111111;
    I2C_Write1ByteRegister(0x6F, 0x01, min);
}

void MCP79410_get_date(
                        uint8_t *day,
                        uint8_t *mouth,
                        uint8_t *year){

    *day = I2C_Read1ByteRegister(0x6F,0x04);
    *day = *day & 0b00111111;

    *mouth = I2C_Read1ByteRegister(0x6F,0x05);
    *mouth = *mouth & 0b00011111;

    *year = I2C_Read1ByteRegister(0x6F,0x06);
}

void MCP79410_get_time(
                        uint8_t *hour,
                        uint8_t *min,
                        uint8_t *sec){

    *sec = I2C_Read1ByteRegister(0x6F,0x00);
    *sec = *sec & 0b01111111;

    *min = I2C_Read1ByteRegister(0x6F,0x01);
    *min = *min & 0b01111111;

    *hour = I2C_Read1ByteRegister(0x6F,0x02);
